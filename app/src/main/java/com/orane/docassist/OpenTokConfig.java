...
public class OpenTokConfig {
    ...
    public static final String API_KEY = "46040582";
    // Replace with a generated Session ID
    public static final String SESSION_ID = Model.webrtc_session_id;
    // Replace with a generated token (from the dashboard or using an OpenTok server SDK)
    public static final String TOKEN = Model.webrtc_token;
